                           ...
                           gpointer data)
{
  ...
  g_signal_emit_by_name (session, "zones-changed", g_variant_new ("a{sv}", &options));
}
           ...
           gpointer         data)
{
  ...
  g_signal_emit_by_name (session, "activated", options);
}
             ...
             gpointer           data)
{
  ...
  g_signal_emit_by_name (session, "deactivated", options);
}
          ...
          gpointer         data)
{
  ...
  g_signal_emit_by_name (session, "disabled");
}
      ...
      while (it)
        {
          ...
          _xdp_input_capture_pointer_barrier_set_active (b, !is_failed);
